...
*Bu denetim raporu Phase 6 kapsamında spec dokümanları baz alınarak hazırlanmıştır. Gerçek kod implementasyonu sonrasında canlı denetim tekrarlanmalıdır.*
