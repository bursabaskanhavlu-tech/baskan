...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    readTime: 5,
    content: `## Otel Havlusu Seçerken Nelere Dikkat Edilmeli?

Otel sektöründe havlu seçimi, misafir memnuniyetini doğrudan etkileyen önemli bir karar. Yanlış seçim hem maliyet hem de müşteri deneyimi açısından olumsuz sonuçlar doğurabilir.

## Gramaj (GSM) Nedir?

Gramaj, kumaşın metrekare başına gram cinsinden ağırlığını ifade eder. Otel sektörü için önerilen aralıklar:

- **300-400 g/m²**: Ekonomik ve pratik kullanım
- **400-500 g/m²**: Orta segment otel standardı
- **500-650 g/m²**: Lüks otel ve 5 yıldızlı tesisler için
...
Otel havlularının endüstriyel yıkama koşullarına dayanıklı olması gerekir. Yüksek sıcaklık ve kimyasal maddelere dirençli iplikler tercih edilmelidir.
...
[Otel havlusu teklifi almak için iletişime geçin →](/contact)`,
  },
  {
    ...
    readTime: 4,
    content: `## Toptan Havlu Alımında Doğru Sorular

Toptan havlu alımı yaparken tedarikçinize doğru soruları sormak, uzun vadeli bir iş ilişkisi kurmanın temelidir.

## 1. Minimum Sipariş Miktarı Nedir?

Her tedarikçinin farklı MOQ politikası vardır. İhtiyacınıza uygun esneklik sunan bir tedarikçi tercih edin.

## 2. Kalite Kontrolünüz Nasıl?

Ürünlerin sevkiyat öncesinde kalite kontrolden geçip geçmediğini öğrenin.

## 3. Numune Gönderme Politikanız Nedir?

Büyük sipariş vermeden önce numune talep etme hakkınız olmalı.

## 4. Teslimat Süreniz Ne Kadar?

Tedarik zincirinizi planlamak için kesin teslimat süreleri önemlidir.

## 5. Özel Üretim Yapabiliyor musunuz?

Logo nakışı, özel renk veya boyut gereksinimleri için özel üretim imkânını sorgulayın.

## 6. Ödeme Koşullarınız Neler?

Ödeme yöntemleri ve vade koşullarını net olarak belirleyin.

## 7. İhracat Deneyiminiz Var mı?

Yurt dışına ihracat yapıyorsanız tedarikçinizin ihracat deneyimi kritik önem taşır.

---

**Başkan Havlu Tekstil** ile çalışmak için [teklif alın →](/contact)`,
  },
  {
    ...
    readTime: 3,
    content: `## Bursa ve Tekstil

Bursa, yüzyıllar boyunca Türkiye'nin tekstil merkezi olmuştur. İpek yolunun önemli bir durağı olan Bursa, günümüzde de havlu ve tekstil üretiminde önemli bir konuma sahiptir.

## Havlucular Çarşısı

Osmangazi ilçesindeki Havlucular Çarşısı, havlu ticaretinin kalbi konumundadır. Onlarca yıllık geçmişiyle bu çarşı, Türkiye'nin ve dünyanın dört bir yanındaki alıcılara hizmet vermektedir.
