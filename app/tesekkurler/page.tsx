...
export default function TesekkurlerPage() {
  ...
  return (
    <main className="flex min-h-[70vh] flex-col items-center justify-center px-4 text-center">
      <div className="flex h-16 w-16 items-center justify-center rounded-full" style={{ backgroundColor: '#f0fdf4' }}>
        <Check className="h-8 w-8 text-green-600" aria-hidden="true" />
      </div>
      <h1 className="mt-6 text-3xl font-bold" style={{ color: '#1a1a1a' }}>Mesajınız İletildi!</h1>
      <p className="mt-4 max-w-md text-lg" style={{ color: '#5c5c5c' }}>
        En geç 24 saat içinde size geri döneceğiz. Acil durumlar için WhatsApp&apos;tan ulaşabilirsiniz.
      </p>
