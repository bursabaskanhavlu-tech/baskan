...
const faqItems = [
  {
    ...
    answer:
      "Bursa Osmangazi'de, Havlucular Çarşısı'nda faaliyet gösteren bir tekstil tedarik ve üretim koordinasyon firmasıyız.",
  },
  {
    question: 'Doğrudan fabrika mısınız?',
    answer:
      'Doğrudan üretim tesisimiz bulunmamaktadır. Güvenilir üreticilerle koordineli çalışarak müşterilerimize kaliteli ürün tedarik ediyoruz.',
  },
  {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <FadeIn className="max-w-2xl">
            ...
            <p className="mt-4 text-lg" style={{ color: '#b3b3b3' }}>
              Bursa Havlucular Çarşısı&apos;nda {SITE_CONFIG.founded}&apos;dan bu yana tekstil
              tedarik ve özel üretim koordinasyonu yapıyoruz.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            <FadeIn>
              ...
              <p className="mt-4 leading-relaxed" style={{ color: '#5c5c5c' }}>
                Başkan Havlu Tekstil, {SITE_CONFIG.founded} yılından bu yana Bursa&apos;da faaliyet
                gösteren bir tekstil tedarik ve özel üretim koordinasyon firmasıdır. Doğrudan
                fabrika olmamamıza rağmen, sektördeki köklü deneyimimiz ve güvenilir üretici ağımız
                sayesinde müşterilerimize yüksek kaliteli ürün tedariki sağlıyoruz.
              </p>
              <p className="mt-4 leading-relaxed" style={{ color: '#5c5c5c' }}>
            ...
            {processSteps.map((s, i) => (
              <FadeIn key={s.step} delay={i * 0.08} className="relative flex flex-1">
                <div className="relative flex flex-1 flex-col items-center px-4 py-6 text-center">
                  ...
                  <h3 className="mt-4 font-semibold" style={{ color: '#1a1a1a' }}>
                    {s.title}
                  </h3>
      ...
      >
        <FadeIn className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl font-bold text-white sm:text-4xl">
            Uluslararası Pazarlara Tedarik
          </h2>
          <p className="mx-auto mt-4 max-w-xl" style={{ color: '#b3b3b3' }}>
            Arap ülkeleri ve Yunanistan başta olmak üzere uluslararası müşterilerimize güvenilir
            tekstil tedariki sağlıyoruz.
          </p>
